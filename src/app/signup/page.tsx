            ...
            <div className="hidden lg:flex flex-col justify-center px-16 bg-primary/5 border-r border-border relative">
                ...
                >
                    ...
                    <div className="space-y-4">
                        {[
                            t('auth.features.srs'),
                            t('auth.features.daily'),
                            t('auth.features.leaderboard'),
                            t('auth.features.cert')
                        ].map((item, i) => (
            ...
            <div className="flex flex-col items-center justify-center p-8 lg:p-24 bg-white dark:bg-card">
                ...
                >
                    <div className="text-center lg:text-left">
                        ...
                        <p className="text-foreground/40 font-medium tracking-tight">{t('auth.onboarding')}</p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="relative flex items-center gap-4 py-2">
                            ...
                            <span className="text-[10px] font-bold text-foreground/30 uppercase tracking-widest">{t('auth.emailSignUp')}</span>
                            <div className="flex-1 border-t border-border" />
                        </div>
                        ...
                        <form onSubmit={handleSignup} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-foreground/40 uppercase tracking-widest ml-1">{t('auth.fullName')}</label>
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-foreground/40 uppercase tracking-widest ml-1">{t('auth.passwordLabel')}</label>
                                <div className="relative">
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-foreground/40 uppercase tracking-widest ml-1">{t('auth.phone')}</label>
                                <div className="relative">
                                    <input
                                        type="tel"
                                        value={phoneNumber}
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-foreground/40 uppercase tracking-widest ml-1">{t('auth.purpose')}</label>
                                <div className="relative">
                                    <textarea
                                        value={purpose}
